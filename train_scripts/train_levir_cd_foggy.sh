...
# cd /home/yqwang/project/PHENet && CUDA_VISIBLE_DEVICES=1 bash train_scripts/train_levir_cd_foggy.sh
# Server background command:
# cd /home/yqwang/project/PHENet && CUDA_VISIBLE_DEVICES=1 nohup bash train_scripts/train_levir_cd_foggy.sh > /tmp/phenet_levir_cd_foggy.launch.log 2>&1 &
